 ...
 * 公告牌页面
 */
@Route(path = ConstantActivityPath.BILLBOARD)
public class BillboardActivity extends TgBaseActivity {
    ...
    private BillboardAdapter adapter = new BillboardAdapter(); // adapter
    ...
    protected void initialized() {
        tvTitle.setText(R.string.activity_billboard);
    ...
    private void initData(final int getDataType) {
        ...
        PostRequest request = TgHttpUtil.requestPost(ConstantUrls.URL_BILLBOARD, getHttpTaskKey());
                ...
                if (result.isSuccess()) {
                    ...
                    if (data != null) {
                        if (TgConstantGetDataType.INIT == getDataType || TgConstantGetDataType.REFRESH == getDataType) {
                            ...
                            // 去重
                            List<BillboardBean> dataList = new ArrayList<>();
